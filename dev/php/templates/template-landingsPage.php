		...
		<article class="Content Content--home" id="post-<?php the_ID(); ?>">
			<content class="Content-Top u-gridRow">
        		<aside class="Content-Top-Aside-Right u-gridCol4">
            		...
            		<img class="Content-Left-Logo" src="<?php echo get_stylesheet_directory_uri(); ?>/img/slider here11.png"/>
...
<!-- ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------>
			<article class=" landingsPage">
				<div class="u-gridRow">
					<article class="u-gridCol8 landingsPage-Left"> 
						<h4><?php the_title(); ?></h4>
						<div>
							<?php the_content(); ?>
					...
					<article class="u-gridCol4 landings-Right"> 
						<div>
                            <img class="Content-Bottom-Images-Img"src="<?php echo get_stylesheet_directory_uri(); ?>/img/14829643-reiniging-artikelen-in-emmer-op-wit-wordt-gea-soleerd.jpg" >
							<a class="button" href="http://qualitygroep.lokaalgevonden.nl/contact/">Neem contact op</a>	
						</div> 
					</article>
				</div>
			</article>
